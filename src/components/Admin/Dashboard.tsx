...
export const adminPanelDashboard: Handler = async (params) => {
  ...
  const props = { latestBans, latestVisitors, currentId, rateLimitMax, rateLimitRemaining };
  return wrapReactPage('AdminPanelDashboard', AdminPanelDashboard, props);
}

export const AdminPanelDashboard: React.FC = ({ latestBans, latestVisitors, currentId, rateLimitMax, rateLimitRemaining }) => {
  return (
    <React.Fragment>
